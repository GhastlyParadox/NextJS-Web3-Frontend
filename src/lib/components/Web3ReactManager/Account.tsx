...
export function Account() {
  ...
  return (
    ...
    <label htmlFor="wallet-modal" className='btn bg-slate-500 modal-button'>
      {active && account ? 
    ...
    <div className='modal modal-bottom sm:modal-middle cursor-pointer'>
      ...
      <label htmlFor="wallet-modal" className="btn btn-xs bg-slate-500 absolute right-2 top-2">✕</label>
