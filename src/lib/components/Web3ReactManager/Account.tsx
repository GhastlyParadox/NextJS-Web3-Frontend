...
export function Account() {
  ...
  return (
    ...
    <label htmlFor="wallet-modal" className='btn modal-button btn-primary'>
      {active && account ? 
    ...
    <div className='modal modal-bottom sm:modal-middle cursor-pointer'>
      ...
      <label htmlFor="wallet-modal" className="btn btn-sm bg-secondary btn-circle absolute right-2 top-2">✕</label>
