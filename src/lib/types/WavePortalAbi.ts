...
export interface WavePortalAbi extends BaseContract {
  ...
  functions: {
    ...
    getUserWaves(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getUserWaves(overrides?: CallOverrides): Promise<PopulatedTransaction>;
